...
public static class NpcProfile
{
    ...
    {
        { "재우", new NpcProfileForm(0) },
        { "우는 아이", new NpcProfileForm(1) },
        { "두루마리 서신", new NpcProfileForm(2) },
        {"우는 아이의 아버지", new NpcProfileForm(3)},
        { "쿠쿠 대왕", new NpcProfileForm(4) }
    };
}
